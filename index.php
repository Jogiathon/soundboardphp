...
<style>#navname{color:GREEN;font-family:'Raleway',sans-serif;font-size:32px;font-weight:800;text-align:center;text-transform:uppercase}#opening{font:600 1.5em/1 'Raleway',sans-serif;color:rgba(0,0,0,.5);text-align:center;text-transform:uppercase;letter-spacing:.5em;position:absolute;top:10%;width:100%}#page{font-weight:bold}</style>
...
<input type=text class=form-control id=username name=name maxlength=15 pattern=^[a-zA-Z]+(?:[a-zA-Z0-9.])*$ data-pattern-error="Must start with a letter and can contain only letters, numbers, and underscores." required>
<div class="help-block with-errors"></div>
</div>
<div class=form-group>
<label for=firstname>First Name:</label>
<input type=text class=form-control id=firstname name=first maxlength=15 pattern=^[a-zA-Z]{1,}$ data-pattern-error="Can contain only letters" data-required-erro="Please fill out this field." required>
<div class="help-block with-errors"></div>
</div>
<div class=form-group>
<label for=lastname>Last Name:</label>
<input type=text class=form-control id=lastname name=last maxlength=15 pattern=^[a-zA-Z]{1,}$ data-pattern-error="Can contain only letters" required>
<div class="help-block with-errors"></div>
</div>
<div class=form-group>
<label for=email>Email:</label>
<input type=email class=form-control id=email name=email maxlength=30 data-error="Invalid email format (E.g. example@gmail.com)" required>
<div class="help-block with-errors"></div>
</div>
<div class=form-group>
<label for=pwd>Password:</label>
<input type=password class=form-control id=pwd name=password data-minlength=6 data-error="Password must have a minimum of 6 characters" required>
<div class="help-block with-errors"></div>
</div>
<div class=form-group>
<label for=inputPwdConfirm>Confirm password:</label>
<input type=password class=form-control id=inputPwdConfirm data-match=#pwd data-match-error="Passwords do not match" required>
<div class="help-block with-errors"></div>
</div>
...
<div class=form-group>
<label for=username>Username:</label>
<input type=text class=form-control id=username name=name maxlength=15 pattern=^[a-zA-Z]+(?:[a-zA-Z0-9.])*$ data-pattern-error="Can contain only letters, numbers, and underscores." required>
<div class="help-block with-errors"></div>
</div>
<div class=form-group>
<label for=pwd>Password:</label>
