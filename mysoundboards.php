...
<style>#navname{color:GREEN;font-family:'Raleway',sans-serif;font-size:32px;font-weight:800;text-align:center;text-transform:uppercase}</style>
...
<input type=text class=form-control name=board_name maxlength=15 pattern=^[a-zA-Z]+(?:[a-zA-Z0-9.])*$ data-pattern-error="Must start with a letter and can contain only letters, numbers, and periods." required>
